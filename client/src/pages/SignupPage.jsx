    ...
    <div className="flex justify-center px-5 py-20 bg-gray-50/50 min-h-[calc(100vh-60px)]">
      ...
      >
        <div className="mb-1">
          ...
          <p className="text-sm text-gray-400 mt-1">Book appointments in seconds, powered by AI</p>
        </div>
        ...
        <label className={labelClass}>
          Password
          <input type="password" name="password" value={form.password} onChange={handleChange} minLength={6} required className={inputClass} />
        </label>
